...
export const financialReportTools = [
    {
        ...
        description: 'List all financial reports (equity summaries, cap table snapshots, tax reports, etc.). ' +
    ...
    },
    {
        ...
        description: 'Generate a new financial report or cap table snapshot for the company.',
        inputSchema: z.object({
