...
export const kycTools = [
    {
        name: 'kyc_status',
        description: 'Check your own KYC accredited investor verification status. ' +
    ...
    },
    {
        ...
        description: 'Submit a self-certification for accredited investor status. ' +
        ...
        inputSchema: z.object({
            ...
            attestationAgreed: coerceBool('Must be true — confirms the investor attests to meeting accreditation criteria'),
        }),
    ...
    },
    {
        ...
        description: 'Submit verification documents for 506(c) accredited investor verification. ' +
    ...
    {
        name: 'kyc_pending',
        description: 'List all pending KYC accredited investor verifications (admin only). ' +
    ...
    {
        name: 'kyc_audit_log',
        description: 'Get the KYC audit trail (admin only). Returns a chronological log of all ' +
