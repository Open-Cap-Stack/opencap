...
export const valuationTools = [
    {
        ...
        description: 'Get the most recent 409A or board-approved valuation for the company.',
    ...
    },
    {
        ...
        description: 'Submit a new 409A valuation request or record a board-approved valuation.',
        inputSchema: z.object({
            companyId: z.string().describe('Company ID'),
            valuationType: z
