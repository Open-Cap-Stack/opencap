...
export const stakeholderTools = [
    {
        name: 'list_stakeholders',
        description: 'List all stakeholders in the cap table. Returns name, email, role, and ownership details. ' +
    ...
    },
    {
        ...
        description: 'Get details for a specific stakeholder by ID. Use the `row_id` field from `list_stakeholders`.',
        inputSchema: z.object({
    ...
    },
    {
        ...
        description: 'Update an existing stakeholder by ID. Use the `row_id` field from `list_stakeholders`.',
        inputSchema: z.object({
            id: z.string().describe('Stakeholder ID — use the `row_id` field from list_stakeholders'),
