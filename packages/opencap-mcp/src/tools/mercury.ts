...
export const mercuryTools: ToolDefinition[] = [
  {
    name: 'mercury_balance',
    description:
      'Get Mercury bank account balance, burn rate, and runway months. ' +
  ...
  },
  {
    ...
    description:
      'Get Mercury transaction activity feed. Supports pagination and date filtering.',
    inputSchema: z.object({
  ...
  },
  {
    ...
    description:
      'Send a payment through Mercury. Requires a recipient ID, amount, and payment method.',
    inputSchema: z.object({
  ...
  },
  {
    ...
    description:
      'Get a financial metrics summary from Mercury suitable for investor updates. ' +
