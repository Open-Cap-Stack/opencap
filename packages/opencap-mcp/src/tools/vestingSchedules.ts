import { z } from 'zod';
import { coerceInt, coerceFloat, coerceBool } from '../schema.js';
import { type ToolDefinition } from '../types.js';

export const vestingScheduleTools: ToolDefinition[] = [
  {
    name: 'list_vesting_schedules',
    description:
      'List all vesting schedules. Returns schedule IDs, stakeholder links, and vesting parameters.',
  ...
  },
  {
    ...
    description:
      'Get full details for a specific vesting schedule by ID, including all vesting events.',
    inputSchema: z.object({
  ...
  },
  {
    ...
    description:
      'Calculate current vesting status for a schedule — how many shares have vested, ' +
  ...
  },
  {
    ...
    description:
      'Apply acceleration to a vesting schedule (e.g. single-trigger on acquisition). ' +
