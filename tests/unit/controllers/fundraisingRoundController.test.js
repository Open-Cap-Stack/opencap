...
describe('FundraisingRoundController', () => {
  ...
  describe('getFundraisingRounds', () => {
    ...
    it('should support filtering by status', async () => {
      ...
      const mockRounds = [
        { _id: 'mongo_1', RoundID: 'FR-001', Status: 'Active' }
      ];
  ...
  describe('ZeroDB Migration Specific Tests', () => {
    ...
    it('should support complex queries in ZeroDB', async () => {
      req.query = {
        Status: 'Active',
        minAmount: '5000000'
      };
  ...
  describe('Edge Cases', () => {
    it('should handle very large target amounts', async () => {
      req.body = {
        RoundID: 'FR-001',
        RoundName: 'Mega Round',
        TargetAmount: 1000000000 // 1 billion
      };
      ...
      databaseAdapter.create.mockResolvedValue(mockRound);
    ...
    it('should handle percentage calculations correctly', async () => {
      ...
      const mockRound = {
        ...
        RoundID: 'FR-001',
        TargetAmount: 10000000,
        RaisedAmount: 7500000 // 75% raised
      };
      ...
      expect(res.statusCode).toBe(200);
      const data = JSON.parse(res._getData());
      expect(data.RaisedAmount / data.TargetAmount).toBe(0.75);
    });
