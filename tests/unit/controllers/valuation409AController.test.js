...
describe('Valuation409A Controller', () => {
  ...
  describe('createValuationRequest', () => {
    it('should create a new valuation request', async () => {
      ...
      Valuation409A.mockImplementation(() => ({
        save: mockSave
      }));
    ...
    it('should return 400 on validation error', async () => {
      mockReq.body = { companyId: 'company_123' }; // missing reason
  ...
  describe('receiveDraft', () => {
    it('should record receipt of draft', async () => {
      ...
      const mockValuation = {
        valuationId: 'val_123',
        status: 'in_progress',
        receiveDraft: jest.fn().mockResolvedValue({
          valuationId: 'val_123',
      ...
      expect(mockValuation.receiveDraft).toHaveBeenCalledWith(
  ...
  describe('cancelValuation', () => {
    it('should cancel a valuation', async () => {
      ...
      expect(mockValuation.transitionTo).toHaveBeenCalledWith(
        'cancelled',
        'user_123',
        'No longer needed'
      );
  ...
  describe('addDocument', () => {
    it('should add document to valuation', async () => {
      ...
      mockReq.body = {
        ...
        name: 'Q1 2024 Valuation Report.pdf'
      };
      ...
      const mockValuation = {
        ...
        addDocument: jest.fn().mockResolvedValue({
          valuationId: 'val_123',
          documents: [{ documentId: 'doc_123', type: 'valuation_report' }]
        })
      };
