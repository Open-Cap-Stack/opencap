...
describe('InvestorController', () => {
  ...
  describe('ZeroDB Migration Specific Tests', () => {
    ...
    it('should support filtering by investorType', async () => {
      req.query = { investorType: 'Angel' };
    ...
    it('should support filtering by relatedFundraisingRound', async () => {
      req.query = { relatedFundraisingRound: 'FR-001' };

      const mockInvestors = [
        { _id: 'mongo_1', investorId: 'INV-001', relatedFundraisingRound: 'FR-001' }
      ];
