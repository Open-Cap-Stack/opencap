...
- `d76693a` Merge pull request #177 from Open-Cap-Stack/feature/issue-175-zerodb-migration-complete
...
- `68644e3` feat: Complete ZeroDB migration for all models (Issue #175)
- `0397290` Merge pull request #176 from Open-Cap-Stack/feature/issue-105-tender-offer-system
- `2683069` Merge pull request #174 from Open-Cap-Stack/feature/issue-119-partner-api-access
- `1597d70` Merge pull request #173 from Open-Cap-Stack/feature/issue-118-webhook-system
- `f47b75e` Merge pull request #172 from Open-Cap-Stack/feature/issue-116-payment-processing
- `84e34dd` Merge pull request #171 from Open-Cap-Stack/feature/issue-115-subscription-system
- `efa48ac` Merge pull request #170 from Open-Cap-Stack/feature/issue-114-subscription-tiers
- `caa2d3d` Merge pull request #169 from Open-Cap-Stack/feature/issue-112-report-scheduling
- `24dfc8c` Merge pull request #168 from Open-Cap-Stack/feature/issue-104-transfer-approval
- `aad4702` Merge pull request #167 from Open-Cap-Stack/feature/issue-103-secondary-transactions
...
- `f0740ef` feat: Implement 6 infrastructure and services features (Issues #45, #47, #48, #49, #50, #51)
- `dd754b6` feat: Implement 5 high-priority features (Issues #44, #56, #78, #102, #110)
- `eff4043` feat: Implement 10 high-priority features (Issues #76, #77, #79, #86, #87, #88, #91, #92, #98, #100)
- `b51819a` Merge pull request #163 from Open-Cap-Stack/feature/issue-43-e2e-tests
- `8fa0d34` test: Add E2E test suite for critical user journeys (Issue #43)
- `06b4baa` Merge pull request #162 from Open-Cap-Stack/feature/issue-46-security-services
- `e9bb833` feat: Add security and compliance services (Issue #46)
- `81c02a7` feat: Implement Valuation Specialist Integration (Issue #61)
- `e0488bc` feat: Implement Valuation Audit Trail (Issue #63)
- `030effb` feat: Implement Material Events Tracking (Issue #60)
- `3d2b64e` feat: Implement 409A Valuation Request System (Issue #59)
- `15e1f17` Merge pull request #161 from Open-Cap-Stack/feature/issue-41-middleware-tests
- `094ceb4` test: Add comprehensive middleware test suite (Issue #41)
- `62ace78` Merge pull request #160 from Open-Cap-Stack/feature/issue-42-integration-tests
- `60c334d` test: Add integration test suite for API workflows (Issue #42)
- `d76bfec` fix: Include docs directory in Docker build for Swagger UI
- `5422e71` fix: Remove services from .dockerignore to fix Railway deployment
- `cc73cdf` chore: Update frontend submodule with AINative auth integration
- `c4f93c5` chore: Update frontend submodule reference
...
controllers/apiMetricsController.js
controllers/bulkMessageController.js
controllers/cacheController.js
controllers/currencyController.js
controllers/dataProcessingController.js
controllers/digitalSignatureController.js
controllers/documentAnalysisController.js
controllers/documentAuditController.js
controllers/documentClassificationController.js
controllers/documentProcessingController.js
controllers/documentSummaryController.js
controllers/documentVersionController.js
controllers/emailTrackingController.js
controllers/equityGrantController.js
controllers/equityPlanReportController.js
controllers/exerciseController.js
controllers/financialAnalyticsController.js
controllers/graphAnalyticsController.js
controllers/investorCommunicationController.js
controllers/investorRightsController.js
controllers/materialEventController.js
controllers/messageTriggerController.js
...
controllers/valuationPartnerController.js
controllers/vestingScheduleController.js
...
e2e/document-management.test.js
e2e/financial-reports.test.js
e2e/health-check.test.js
e2e/spv-management.test.js
